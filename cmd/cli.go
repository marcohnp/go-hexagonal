...
import (
	"fmt"
	"github.com/marcohnp/go-hexagonal/adapters/cli"
...
var cliCmd = &cobra.Command{
	Use:   "cli",
	Short: "Command for initialize adapter CLI",
	Long:  `Command for initialize CLI interface for interact with application.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("CLI is started.")
