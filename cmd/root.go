...
import (
	"database/sql"
	dbInfra "github.com/marcohnp/go-hexagonal/adapters/db"
...
var rootCmd = &cobra.Command{
	Use:   "go-hexagonal",
	Short: "Application GO-Hexagonal",
	Long:  `This is an application for pratice Hexagonal Architecture (Ports and Adapters) with GO Lang.`,
